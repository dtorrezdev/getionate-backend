...
import com.dtorrez.main.controllers.dto.EtiquetaRequest;
import com.dtorrez.main.controllers.dto.EtiquetaResponse;
// import bo.com.micrium.modulobase.security.utils.JWTTokenUtil;
import com.dtorrez.main.validators.EtiquetaValidator;
...
public class EtiquetaControler extends GenericControler
        implements ICrudControler<EtiquetaRequest, EtiquetaResponse, String> {
    ...
    public ResponseEntity<EtiquetaResponse> get(String token, String ipClient, String form,
         ...
         * if (model.isPresent()) {
         * ResponseEntity<EtiquetaResponse> out =
    ...
    public ResponseEntity<EtiquetaResponse> create(String token, String tenantId, String ipClient, String form,
        ...
        try {
            ...
            final Long logSistemaId = logWeb.error(obtenerNombreUsuario(), Apps.TRAZABILIDAD_SISTEMA,
                    Acciones.ETIQUETA_CREAR, mensajeError, e);
            map.put(TiposComunes.MENSAJE_ERROR, mensajeError);
    ...
    public ResponseEntity<EtiquetaResponse> update(String token, String ipClient, String form,
        ...
        try {
            ...
            ResponseEntity<EtiquetaResponse> out = ResponseEntity.ok()
                    .body(ConvercionUtil.convertToObject(model, EtiquetaResponse.class));
            ...
            final Long logSistemaId = logWeb.error(obtenerNombreUsuario(), Apps.TRAZABILIDAD_SISTEMA,
                    Acciones.ETIQUETA_MODIFICAR, mensajeError, e);
            map.put(TiposComunes.MENSAJE_ERROR, mensajeError);
            bitacoraService.guardarBitacora(token, ipClient, form, Acciones.ETIQUETA_MODIFICAR, map, mapNuevo,
                    logSistemaId);
