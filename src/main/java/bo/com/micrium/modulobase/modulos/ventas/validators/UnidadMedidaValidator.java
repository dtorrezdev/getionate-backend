package bo.com.micrium.modulobase.modulos.ventas.validators;
...
@Component
public class UnidadMedidaValidator extends GlobalValidator {
    ...
    public void validate(UnidadMedidaRequest input, Long id, Errors errors) {
