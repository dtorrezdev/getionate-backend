package bo.com.micrium.modulobase.modulos.ventas.controllers.dtos.venta.update;
...
public class VentaUpdateRequest implements Serializable {
    @NotNull(message = "Venta Id no puede ser null.")
    private Long id;
